...
def main(text: str = "Tilecode", output_path: Optional[Union[str, Path]] = None):
    ...
    # add vgrid GeoJSON overlay if available
    geojson_path = Path(__file__).with_name("tilecode.geojson")
